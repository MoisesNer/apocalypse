...
export default function About() {
    return (
        ...
        <div className='aboutTeam'>
            ...
            <p className='aboutTeamText'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique numquam quae sequi ipsam qui sint minus unde quidem explicabo quisquam, consequatur error doloremque eius rem sapiente molestiae quas nisi velit cumque id. Ad dolorum quaerat quo, mollitia voluptate deserunt numquam!
            </p>
